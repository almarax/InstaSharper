        ...
        public static Dictionary<string, AndroidDevice> AndroidAndroidDeviceSets =
            new Dictionary<string, AndroidDevice>
            {
                ...
                //},
                {
                    ...
                    new AndroidDevice
                    {
                        AndroidBoardName = "universal9810",
                        AndroidBootloader = "G920FXXU3DPEK",
                        DeviceBrand = "samsung",
                        DeviceModel = "star2lte",
                        DeviceModelBoot = "qcom",
                        DeviceModelIdentifier = "SM-G965F",
                        FirmwareBrand = "star2ltexx",
                        FirmwareFingerprint =
                            "samsung/star2ltexx/star2lte:9/PPR1.180610.011/G965FXXu5CSF2:user/release-keys",
                        FirmwareTags = "dev-keys",
                        FirmwareType = "user",
                        HardwareManufacturer = "samsung",
                        HardwareModel = "samsungexynos9810",
                        DeviceGuid = new Guid("54274B68-8E49-4E6D-8DB2-5E626517D949"),
                        PhoneGuid = new Guid("8EC20B30-AEA2-4329-BCDD-C0530328BC67")
                    }
                },
                //{
                //    "galaxy-s5-gold",
